...
export function RegisterForm() {
  return (
    <Card className="shadow-xl border border-white/10 backdrop-blur-md" style={{ backgroundColor: "rgba(255,255,255,0.07)" }}>
      <CardHeader className="space-y-1 text-center">
        <CardTitle className="text-2xl font-bold text-white">Crear cuenta</CardTitle>
        <CardDescription className="text-white/60">Comienza tu viaje nutricional hoy</CardDescription>
      </CardHeader>
